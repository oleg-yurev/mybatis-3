 ...
 * 
 */
public class MultipleResultSetAssociationTest {

  private static SqlSessionFactory sqlSessionFactory;

  @BeforeClass
  public static void setUp() throws Exception {
    Reader reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/multipleresultsetwithannotations/mybatis-config.xml");
    ...
    reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/multipleresultsetwithannotations/CreateDB1.sql");
    runReaderScript(conn, session, reader);
    reader.close();
    reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/multipleresultsetwithannotations/CreateDB2.sql");
    runReaderScript(conn, session, reader);
    reader.close();
    reader = Resources.getResourceAsReader("org/apache/ibatis/submitted/multipleresultsetwithannotations/CreateDB3.sql");
    runReaderScript(conn, session, reader);
    reader.close();
    session.close();
  }
  ...
  public void shouldGetOrderDetailsEachHavingAnOrderHeader() throws IOException {
    ...
    try {
      ...
      for(OrderDetail orderDetail : orderDetails){
          ...
          Assert.assertEquals(orderDetail.getOrderHeader().getOrderId(), orderDetail.getOrderId());
      }
